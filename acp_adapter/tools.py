...
def build_tool_start(
    ...
    if tool_name == "read_file":
        # Keep the start compact; completion carries file contents.
        # The title and location already identify the file, and a synthetic
        # "Reading ..." block makes Zed render an extra Output section.
        return acp.start_tool_call(
